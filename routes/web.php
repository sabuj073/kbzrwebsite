...
Route::any('/delete-pending', [OrderController::class, 'deletepending'])->name('deletepending');


Route::any('/payment/callback', [PaymentController::class, 'callback'])->name('callback');
Route::any('/payment/wallet/callback', [PaymentController::class, 'wallet_callback'])->name('wallet_callback');
Route::any('/payment/customer_package_payment/callback', [PaymentController::class, 'customer_package_payment_callback'])->name('customer_package_payment_callback');
Route::any('/payment/seller_package_payment/callback', [PaymentController::class, 'seller_package_payment_callback'])->name('seller_package_payment_callback');
...
Route::group(['prefix' => 'checkout'], function () {
    Route::controller(CheckoutController::class)->group(function () {
        ...
        Route::any('/payment-select', 'store_delivery_info')->name('checkout.store_delivery_info');
...
Route::post('/cards/store', [CustomerCardController::class, 'store'])->name('cards.store');
Route::get('/cards', [CustomerCardController::class, 'getCards'])->name('cards.get');
Route::get('/cards/{id}', [CustomerCardController::class, 'getCarddetails'])->name('cards.get.details');
Route::put('/cards/update/{id}', [CustomerCardController::class, 'update'])->name('cards.update');
Route::delete('/cards/delete/{id}', [CustomerCardController::class, 'delete'])->name('cards.delete');
