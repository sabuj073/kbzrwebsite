...
class OrderController extends Controller
{
    ...
    public function deletepending(){
        ...
        $order_data = Order::where('payment_type', 'sslcommerz')
    ...
    public function store(Request $request)
    {
        ...
        $address = Address::where('id', $carts[0]['address_id'])->orderBy("id","desc")->first();
        ...
        if ($address != null) {
            ...
            $shippingAddress['security_code'] = $address->security_code;
            $shippingAddress['delivery_where'] = $address->delivery_where;
