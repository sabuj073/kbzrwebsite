...
class SellerPackageController extends Controller
{
    ...
    public function purchase_payment_done($payment_data, $payment)
    {
        ...
        $seller->seller_package_id = $payment_data;
        $seller_package = SellerPackage::findOrFail($payment_data);
        ...
        $seller_package->seller_package_id = $payment_data;
        $seller_package->payment_method = "Online Data";
